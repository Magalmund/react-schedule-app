    ...
    return (
        <div className="h-screen w-full fixed left-0 top-0 flex justify-center items-center">
            <form className="bg-white rounded-lg shadow-2xl w-1/4">
                <header className="bg-gray px-10 py-2 flex justify-between items-center">
                ...
                <footer className="flex justify-end border-t py-2 px-10 mt-5 border-b-2 border-gray-200">
                    <button
                        type="submit"
